...
const Terms = () => {
  return (
    <div className={`${container} my-6`}>
      ...
      <section className="mt-4">
        <h3 className={sectionTitle}>2. Use of Service</h3>
        <p className={subText}>
      ...
      <section className="mt-4">
        <h3 className={sectionTitle}>3. Intellectual Property</h3>
        <p className={subText}>
      ...
      <section className="mt-4">
        <h3 className={sectionTitle}>4. Termination</h3>
        <p className={subText}>
      ...
      <section className="mt-4">
        <h3 className={sectionTitle}>5. Disclaimers & Liability</h3>
        <p className={subText}>
      ...
      <section className="mt-4">
        <h3 className={sectionTitle}>6. Contact Us</h3>
        <p className={subText}>
